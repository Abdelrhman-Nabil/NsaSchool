import FormContainer from "@/app/component/comp/formContianer";
...
const TeacherListPage =  async ({searchParams}: 
  ...
  const {page ,...quaryPrams}=searchParams;
  const p=page?parseInt(page):1;

  const quary:Prisma.TeacherWhereInput={}
  if(quaryPrams){
    for(const [key,value] of Object.entries(quaryPrams)){
      if(quaryPrams !== undefined){
        switch (key) {
          case "classId":
            quary.lessons={
              some:{
