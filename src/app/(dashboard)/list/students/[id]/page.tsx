...
import Performance from "@/app/component/comp/performanceShart"
...
import StudentAttendanceCard from "@/app/component/comp/StudentAttendanceCard"
...
<div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row ">
  ...
  <div className="flex-1 flex gap-4 justify-between flex-wrap">
    ...
    <div className="bg-white p-4 rounded-md ">
        ...
        <Link className="p-3 rounded-md bg-[#EDF9FD]"
         href={`/list/lessons?classId=${student.class.id}`}>Student's  Lessons</Link>
        <Link className="p-3 rounded-md bg-[#F1F0FF]"
         href={`/list/teachers?classId=${student.class.id}`}>Student's  Teachers</Link>
        <Link className="p-3 rounded-md bg-pink-50"
         href={`/list/exams?classId=${student.class.id}`}>Student's  Exams</Link>
        <Link className="p-3 rounded-md bg-[#EDF9FD]"
         href={`/list/assignments?classId=${student.class.id}`}>Student's  Assignments</Link>
        <Link className="p-3 rounded-md bg-[#EDF9FD]"
         href={`/list/results?studentId=${student.id}`}>Student's  Result</Link>
